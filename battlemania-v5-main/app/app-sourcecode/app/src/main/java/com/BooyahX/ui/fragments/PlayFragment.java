...
import com.BooyahX.models.GameData;
import com.BooyahX.ui.activities.AnnouncementActivity;
import com.BooyahX.ui.activities.LudoActivity;
...
import com.BooyahX.ui.adapters.TestFragmentAdapter;
import com.BooyahX.utils.KKViewPager;
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                new FancyShowCaseQueue()
                        ...
                        .show();
                Picasso.get().load(Uri.parse(data.getGameImage())).placeholder(R.drawable.default_booyahx).fit().into(gamebaner);
