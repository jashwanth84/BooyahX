...
import com.BooyahX.ui.adapters.TabAdapter;
import com.BooyahX.ui.fragments.FragmentSelectedLotteryDescription;
import com.BooyahX.ui.fragments.FragmentSelectedLotteryJoinedeMember;
...
public class SelectedLotteryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.equals(baner, "")) {
            ...
            Picasso.get().load(Uri.parse(baner)).placeholder(R.drawable.default_booyahx).fit().into(imgeViewSelected);
        } else {
            imgeViewSelected.setImageDrawable(getDrawable(R.drawable.default_booyahx));
