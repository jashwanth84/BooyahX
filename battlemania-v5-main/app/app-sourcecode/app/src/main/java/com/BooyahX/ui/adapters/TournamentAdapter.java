...
import com.BooyahX.models.TournamentData;
import com.BooyahX.ui.activities.SelectMatchPositionActivity;
import com.BooyahX.ui.activities.SelectedTournamentActivity;
...
public class TournamentAdapter extends RecyclerView.Adapter<TournamentAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final TournamentAdapter.MyViewHolder holder, int position) {
        ...
        if (!tournamentData.getMatchbanner().equals("")) {
            Picasso.get().load(Uri.parse(tournamentData.getMatchbanner())).placeholder(R.drawable.default_booyahx).fit().into(holder.imageView);
        } else {
            holder.imageView.setVisibility(View.GONE);
            //holder.imageView.setImageDrawable(mContext.getDrawable(R.drawable.default_booyahx));
        }
