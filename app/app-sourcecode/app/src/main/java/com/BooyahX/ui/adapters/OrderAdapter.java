...
import com.BooyahX.models.OrderData;
import com.BooyahX.ui.activities.SingleOrderActivity;
...
public  class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrderAdapter.MyViewHolder holder, int position) {
        ...
        if (!data.getpImage().equals("")) {
            Picasso.get().load(Uri.parse(data.getpImage())).placeholder(R.drawable.booyahxlogo).fit().into(holder.iv);
        } else {
            holder.iv.setImageDrawable(mContext.getDrawable(R.drawable.booyahxlogo));
        }
